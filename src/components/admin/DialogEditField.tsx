...
interface Props {
    ...
    handleUpdate: (payload: Payload) => void;
}
...
export default function DialogEditField({
    ...
    const [weekdayPrice, setWeekdayPrice] = useState<number | "">(field.weekday_price)
    const [weekendPrice, setWeekendPrice] = useState<number | "">(field.weekend_price)
